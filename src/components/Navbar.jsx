...
function Navbar() {
  ...
  return (
    <div className='flex items-center px-[4%] justify-between  h-[64px] bg-black sticky top-0 z-50'>
        <div className='flex m-0 text-white box-border '>
        ...
        <div className='flex  text-white font-[14px]  gap-6 items-center'>
